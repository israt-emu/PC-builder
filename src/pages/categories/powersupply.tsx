...
const PowerSupply: NextPageWithLayout<IProductProps> = ({products}) => {
  return (
...
PowerSupply.getLayout = function getLayout(PowerSupply: ReactElement) {
  return <RootLayout>{PowerSupply}</RootLayout>;
};
