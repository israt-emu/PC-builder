...
const OtherCategory: NextPageWithLayout<IProductProps> = ({products}) => {
  return (
...
OtherCategory.getLayout = function getLayout(OtherCategory: ReactElement) {
  return <RootLayout>{OtherCategory}</RootLayout>;
};
