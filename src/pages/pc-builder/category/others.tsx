...
const PCBuilderOtherCategory: NextPageWithLayout<IProductProps> = ({products}) => {
  return (
    <div className="container mx-auto py-12">
      <h1 className="text-lg text-accent bg-background py-2 px-4 shadow-md mb-4  md:w-3/6 lg:w-2/6 font-semibold">Others Category(Keyboard, mouse,etc)</h1>
...
PCBuilderOtherCategory.getLayout = function getLayout(PCBuilderOtherCategory: ReactElement) {
  return <RootLayout>{PCBuilderOtherCategory}</RootLayout>;
};
...
export default PCBuilderOtherCategory;
