...
const PCBuilderMotherBoard: NextPageWithLayout<IProductProps> = ({products}) => {
  ...
  return (
    <div className="md:container w-10/12 mx-auto py-12">
      <h1 className="text-lg text-accent bg-background py-2 px-4 shadow-md mb-4  md:w-3/6 lg:w-2/6 font-semibold">Motherboard</h1>
